def carregar_ultima_combinacao(arquivo="ultimo.txt"):
    ...
    Retorna (palavra_base, palavra_completa, mnemonic)
    palavra_completa = duas últimas palavras (ex: 'comp1 comp2')
    """
    import os
    ...
    try:
        with open(arquivo, 'r', encoding='utf-8') as f:
            ...
            if len(palavras) == 12:
                ...
                palavra_completa = palavras[10] + ' ' + palavras[11]
                mnemonic = ' '.join(palavras)
                return palavra_base, palavra_completa, mnemonic
    except Exception:
        pass
    return None, None, None
